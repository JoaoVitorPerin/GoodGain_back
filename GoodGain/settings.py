"""
Django settings for GoodGain project.
...
SECRET_KEY = 'django-insecure-zz(zy=a9017=f)x)(g8pe!3im(=xp1gdikdri6uu)y9xc%-^e4'
...
WSGI_APPLICATION = 'GoodGain.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',
        'USER': 'postgres.yplatbhotdufskjaiich',
        'PASSWORD': 'vUsNlDt6tWxrBXt3',
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "BO.autenticacao.autenticacao.AutenticacaoSerializer",
